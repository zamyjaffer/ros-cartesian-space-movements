...
sizes on the x-y Cartesian plane, starting from a given robot configuration. This project consists of 2 nodes:
  1. 'square_size_generator.py' which generates random pramaters for the size of the square.
  2. 'move_panda_square.py' which plans, shows and executs the movement of the panda robot.
...
- in a new terminal, from your catkin_workspace navigate to the scripts folder: 
